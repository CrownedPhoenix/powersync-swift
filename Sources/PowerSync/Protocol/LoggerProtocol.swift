...
///
/// - Note: This is a legacy abstraction; new code should prefer `Logging.Logger` directly. The
///   `asSwiftLogger()` extension bridges a `LoggerProtocol` to a swift-log `Logger`.
